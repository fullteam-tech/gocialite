...
Change [line 12](https://github.com/fullteam-tech/gocialite/blob/master/drivers/bitbucket.go#L12) with:
...
Now on [line 19](https://github.com/fullteam-tech/gocialite/blob/master/drivers/bitbucket.go#L19) you have to create the mapping from API to populate the User struct.  
...
Finally, on [lines 26-30](https://github.com/fullteam-tech/gocialite/blob/master/drivers/bitbucket.go#L26-L30) you have to fill the fields for the endpoint baseurl and the path of the user endpoint.  
...
## Testing
Use the [example page](https://github.com/fullteam-tech/gocialite/wiki/Example) as starting point. Set up the credentials of your app in the `providerSecrets` variable, like:
